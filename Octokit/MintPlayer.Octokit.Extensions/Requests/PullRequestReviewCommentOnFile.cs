...
public sealed class PullRequestReviewCommentOnFile
{
    public PullRequestReviewCommentOnFile() { }

    public PullRequestReviewCommentOnFile(long id)
    {
        Id = id;
    }

    public PullRequestReviewCommentOnFile(string url, long id, string nodeId, string diffHunk, string path, string commitId, string originalCommitId, User user, string body, DateTimeOffset createdAt, DateTimeOffset updatedAt, string htmlUrl, string pullRequestUrl, ReactionSummary reactions, long? inReplyToId, long? pullRequestReviewId, AuthorAssociation authorAssociation)
    {
