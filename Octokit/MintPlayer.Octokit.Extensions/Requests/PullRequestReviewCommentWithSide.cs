...
public class PullRequestReviewCommentWithSide
{
    public PullRequestReviewCommentWithSide() { }

    public PullRequestReviewCommentWithSide(long id)
    {
        Id = id;
    }

    public PullRequestReviewCommentWithSide(string url, long id, string nodeId, string diffHunk, string path, int? line, EPullRequestReviewCommentSide side, string commitId, string originalCommitId, User user, string body, DateTimeOffset createdAt, DateTimeOffset updatedAt, string htmlUrl, string pullRequestUrl, ReactionSummary reactions, long? inReplyToId, long? pullRequestReviewId, AuthorAssociation authorAssociation)
    {
